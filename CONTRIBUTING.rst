...
Thank you for your help improving **GEE Pillow**!

**GEE Pillow** uses `nox <https://nox.thea.codes/en/stable/>`__ to automate several development-related tasks.
...
First off, you'll need your own copy of **GEE Pillow** codebase. You can clone it for local development like so:
...
.. code-block:: console
   ...
   git clone https://github.com/<YOUR USERNAME>/geepillow
   cd geepillow
...
This will install the **GEE Pillow** library, together with two additional tools:
